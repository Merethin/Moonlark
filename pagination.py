# pagination.py - Multiple-page Discord view widget
# Taken from https://stackoverflow.com/questions/76247812/how-to-create-pagination-embed-menu-in-discord-py#76250596
# Tweaked by Merethin to add type annotations
